...
import module namespace processConcept="https://ausohnum.huma-num.fr/skosThesau/processConcept" at "process-concept.xql";
  ...
  <div  data-template="templates:surround" data-template-with="./templates/page.html" data-template-at="content">
      ...
      <div class="container">
          <div class="row row-centered">
              ...
              <script src="/resources/scripts/loadSkosThesau.js" type="text/javascript"/>
