...
let $functions-collection := skosThesau:getChildren("https://ausohnum.huma-num.fr/concept/c23489", $project)
...
return
    ...
    <items>
        ...
        <dataset_path>
            <title>Patrimonium Bond types</title>
            <id>Patrimonium Bond types</id>
        </dataset_path>
