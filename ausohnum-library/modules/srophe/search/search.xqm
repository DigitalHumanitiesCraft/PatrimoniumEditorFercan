         ...
         <div class="indent" id="search-results" xmlns="http://www.w3.org/1999/xhtml">
         {
                 ...
                 return 
                  <div class="row record" xmlns="http://www.w3.org/1999/xhtml" style="border-bottom:1px dotted #eee; padding-top:.5em">
                      ...
                      <div class="col-md-11" style="margin-right:-1em; padding-top:.25em;">
                          {tei2html:summary-view($hit, '', $xmlid)}
                          {
                             if($kwic//exist:match) then 
                                tei2html:output-kwic($kwic, $xmlid)
                             else ()
                          }
                      </div>
                  </div>   
...
(: if(exists(request:get-parameter-names())) then ()
    ...
    let $search-config := 
        if($collection != '') then concat('/db/apps/', $project, '/', string(config:collection-vars($collection)/@app-root),'/','search-config.xml')
        else concat('/db/apps/', $project, '/','search-config.xml')
    return 
