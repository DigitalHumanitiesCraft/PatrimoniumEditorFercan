...
<div
            ...
            <h2 id="docMainTitle">{$teiDoc//tei:titleStmt/tei:title/string()}
            <!--<span class="pull-right">{teiEditor:displayEditorLabel("editing_document")} {$docId}</span>
            -->
            </h2>
            <h4><span class="pastilleLabelBlue pastilleURI">URI</span>{ teiEditor:buildDocumentUri($docId) }</h4>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-6">
                  ...
                  {teiEditor:displayElement('docType', (), (), ())}
                        ...
                        {teiEditor:bibliographyPanel($docId, "edition")}
                        <h4>Datation</h4>
...
(:                        teiEditor:peopleList($docId):)
                       ...
                       <h4>External resources</h4>
                        ...
                        {teiEditor:bibliographyPanel($docId, "secondary")}
