...
let $template := doc('/db/apps/patrimonium/data/templates/empty-doc.xml')
let $text := $template//text/string()
...
let $text2 := normalize-space(serialize($template//div[@type="edition"]/ab/node(), $serializationParam))
let $model :=
<div id="model" >
        ...
        <xf:instance xmlns="" id="i_document">
            <apc:document>
              ...
              <dct:contributor>{$currentUser}</dct:contributor>
                {
                $template/apc:document/child::node()[not(self::dct:created)]}
            </apc:document>
...
<xf:bind
            id="doc_title"
            ref="instance('i_document')/TEI/teiHeader/fileDesc/titleStmt/title"/>
            -->
        <xf:bind
            id="doc_title"
            ref="instance('i_document')/*[local-name() = 'label']"/>
        <xf:bind
            id="doc_id"
            ref="instance('i_document')/*[local-name() = 'identifier']"/>            
         <xf:bind
            id="doc_type"
...
<!--        <div class="hidden" >-->
    ...
    <div class="container form" id="newDoc">
          <div class="row newDocHeader">
                        ...
                        <div id="titlepanel" class="panel-collapse collapse in">
                              <div class="panel-body">
                                      <xf:group appearance="minimal" >
                                                  <xf:textarea id="docTitleInput" class="fullwidth" bind="doc_title" incremental="true" row="2">
                                                  ...
                                                  <xf:select1 id="docTypeSelect" bind="doc_type" incremental="true">
                                                   ...
                                                   <xf:reapeat id="repeatBiblioEdition" bind="doc_biblio_edition" appearance="compact" >
                                                   ...
                                                   <xf:textarea id="editionRawTextArea" class="fullwidth" bind="doc_biblio_editionRaw" >
  ...
  <div class="tab-pane fade" id="nav-commentary" role="tabpanel" aria-labelledby="nav-commentary-tab">
   ...
   <button id="callInsertBiblio"  class="btn btn-default" data-target="#dialogInsertBiblio">Insert Biblio.</button>
        ...
        <h4>Ancient Text<button id="callTextImport"  class="btn btn-default pull-right" data-target="#dialogTextImport">Import text</button></h4>
            ...
            <xf:textarea id="ancientText" class="fullwidth bfHidden" bind="document_text" >
